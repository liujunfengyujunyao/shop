<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/machine\stocklog.html";i:1534753814;s:44:"./application/admin/view2/public\layout.html";i:1536395974;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="search-form" method="post" action="<?php echo U('store/stocklog'); ?>" onsubmit="return check_form();">
                ...
                <div class="sDiv">
                    ...
                    <div class="sDiv2">
                        <input size="30" placeholder="配送员手机号" value="<?php echo \think\Request::instance()->request('mobile'); ?>" name="mobile" class="qsbox" type="text">
                ...
                <table cellspacing="0" cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 200px;" class="">贩卖机</div>
                        </th>
