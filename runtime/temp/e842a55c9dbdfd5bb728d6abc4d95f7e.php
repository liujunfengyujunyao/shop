<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./template/pc/rainbow/goods\goodsList.html";i:1533876251;s:40:"./template/pc/rainbow/public\header.html";i:1533876251;s:44:"./template/pc/rainbow/public\new-footer.html";i:1534215383;s:46:"./template/pc/rainbow/public\sidebar_cart.html";i:1534215381;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
                                    ...
                                    <div class="cata-nav-left">
                                        <div class="subitems">
                                            ...
                                            <div class="advertisement_down">
                                                <ul>                                                
                                                    <?php $pid =14;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1536742800 and end_time > 1536742800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
...
foreach($result as $key=>$v3):       
    ...
    ?>
                                    ...
                                    <div class="cata-nav-rigth">
                                        <?php $pid =51;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1536742800 and end_time > 1536742800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
