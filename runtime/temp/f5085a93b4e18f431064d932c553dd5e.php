<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:38:"./template/phone/new/machine\edit.html";i:1542449098;}*/ ?>
<!DOCTYPE html>
<html lang="en" id="rootHTML">
    <head>
        ...
        <link rel="stylesheet" href="__NEW__/css/font-awesome.min.css">
        ...
        <div class="device_body">
            <div class="d_body">
                ...
                <div id="d_goup">
                    ...
                    <!-- <input type="text" id="input2"  placeholder="请输入所属群组" value="<?php echo $info['group_name']; ?>"> -->
                ...
                <!-- 当前位置：<input  type="text"   id="txtposition" value="正在定位..."/> -->
                    ...
                    <input type="text" id="suggestId" placeholder="请输入地址" value="<?php echo $info['address']; ?>" />
