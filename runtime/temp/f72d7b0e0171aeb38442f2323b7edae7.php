<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/goods\_goods.html";i:1534924564;s:44:"./application/admin/view2/public\layout.html";i:1534924564;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--通用信息-->
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="send_good">赠品</label>
                </dt>
                <dd class="opt">
                    <select name="send_id" id="send_id" class="small form-control">
                        <option value="0">无</option>
                        <?php if(is_array($send_goods) || $send_goods instanceof \think\Collection || $send_goods instanceof \think\Paginator): $i = 0; $__LIST__ = $send_goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sd): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $sd['goods_id']; ?>" <?php if($sd['goods_id'] == $goodsInfo['send_id']): ?>selected="selected"<?php endif; ?> ><?php echo $sd['goods_name']; ?></option>
...
<!--积分折扣-->
        <div class="ncap-form-default tab_div_5" style="display:none;">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="record_no">推荐人赠送积分</label>
                </dt>
                <dd class="opt">
                    <input type="text" value="<?php echo $goodsInfo['invite_give_integral']; ?>" name="invite_give_integral" class="t_mane" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />    订单完成后给推荐人赠送积分
                    <span class="err" id="err_invite_give_integral" style="color:#F00; display:none;"></span>
                </dd>
            </dl>
