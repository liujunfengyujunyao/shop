<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./template/phone/new/goods\stock_index.html";i:1536839266;}*/ ?>
<!DOCTYPE html>
		...
		<ul class="main list-group">
			...
			>
				<span 
					...
					<span class="label label-primary">一号机器</span></span>
				<span class="title textFlow"><span class="label label-default">北京市东城区</span></span>
				<!-- 折叠部分 -->
