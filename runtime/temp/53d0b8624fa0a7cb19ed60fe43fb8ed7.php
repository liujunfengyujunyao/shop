<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./application/admin/view2/machine\stockList.html";i:1536396032;s:44:"./application/admin/view2/public\layout.html";i:1536395974;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" id="search-form" method="post" action="<?php echo U('/Admin/Machine/stockList'); ?>">
				<div class="sDiv">
					...
					<div class="sDiv2">
						<input size="30" placeholder="贩卖机姓名" value="<?php echo \think\Request::instance()->request('machine_name'); ?>" name="machine_name" class="qsbox" type="text">
		...
		<div id="accordion">
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
				<h3>
					<span><?php echo $val['machine_name']; ?></span>
