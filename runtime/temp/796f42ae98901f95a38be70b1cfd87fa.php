<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view2/machine\index.html";i:1534753044;s:44:"./application/admin/view2/public\layout.html";i:1533876247;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="mDiv">
      ...
      <form class="navbar-form form-inline" id="search-form2" method="get" onsubmit="return false" action="<?php echo U('/Admin/Store/ajaxStoreList'); ?>">
                <div class="sDiv">
                    ...
                    <div class="sDiv2">
                        <input size="30" name="key_word" value="<?php echo \think\Request::instance()->param('key_word'); ?>" placeholder="贩卖机名称" class="qsbox" type="text">
...
<script>
    ...
    function ajax_get_table(form,page) {
        ...
        $.ajax({
            type: "POST",
            url: "/index.php?m=Admin&c=Machine&a=ajaxMachineList&p="+page,
