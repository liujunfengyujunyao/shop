<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"./application/admin/view2/goods\ajaxGoodsAttributeList.html";i:1533876247;}*/ ?>
<table>
       <tbody>
              ...
              <tr data-id="<?php echo $list['attr_id']; ?>">
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 170px; max-width:170px;">                   
                    <a class="btn red"  href="<?php echo U('Admin/goods/delGoodsAttribute',array('id'=>$list['attr_id'])); ?>"><i class="fa fa-trash-o"></i>删除</a>
