<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/partner\delivery.html";i:1534831079;s:44:"./application/admin/view2/public\layout.html";i:1533876247;}*/ ?>
<!doctype html>
<html>
<head>
			...
			success: function (data) {
				if (data.status == 1) {
					layer.msg(data.msg, {icon: 1, time: 2000}, function() {
						...
						parent.location.href = "<?php echo U('Admin/Order/delivery_list', array('inc_type'=>'partner_order_list')); ?>";
					});
				} else {
