<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./template/pc/rainbow/partner\store_list.html";i:1535780986;s:38:"./template/pc/rainbow/user\header.html";i:1534215376;s:36:"./template/pc/rainbow/user\menu.html";i:1535780304;s:46:"./template/pc/rainbow/public\footer_index.html";i:1534215384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>设备管理-<?php echo $tpshop_config['shop_info_store_title']; ?></title>
...
<div class="home-index-middle">
	...
	<div class="menu-ul">
		...
		<?php if($user['level'] == 8): ?> <!-- 用户等级为配货员 -->
		<ul>
			<li class="ma"><i class="account-acc6"></i>设备管理</li>
			<li><a href="<?php echo U('Home/Partner/storeList'); ?>">设备列表</a></li>
			<li><a href="<?php echo U('Home/Partner/orderList'); ?>">设备订单</a></li>
			<li><a href="<?php echo U('Home/Partner/store_apply'); ?>">设备补货申请</a></li>
		...
		<?php endif; ?>
			...
			<div class="ri-menu fr">
				<div class="menumain p">
					<div class="goodpiece">
						<h1>设备管理 </h1>
						<span>（已负责 <em class="red"><?php echo $pager->totalRows; ?></em> 个设备）</span>
					</div>
					...
					<?php if($list): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<div class="card-list c_contan accbala-list">
							<ul>
								<li><span><?php echo $vo['machine_name']; ?></span></li>
								...
								<li>
									<a href="<?php echo U('Partner/store_stock_list', array('id'=>$vo['machine_id'])); ?>">查看库存</a></li>
							</ul>
						</div>
