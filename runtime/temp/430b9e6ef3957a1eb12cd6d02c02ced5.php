<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"./template/mobile/new2/partner\index.html";i:1533876250;s:41:"./template/mobile/new2/public\header.html";i:1533876250;s:45:"./template/mobile/new2/public\footer_nav.html";i:1533876250;s:43:"./template/mobile/new2/public\wx_share.html";i:1533876250;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<div class="myhearder">
    <div class="person">
        ...
        <div class="fl lors">
            <span>合伙人：<?php echo $user['nickname']; ?></span>
        </div>
    </div>
        ...
        <ul>
            <li>
                <a href="javascript:void(0)">
                    <p>联系方式：<?php echo $partner['phone']; ?></p>
                </a>

            </li>
            <li>
                <a href="<?php echo U('Mobile/Partner/rebate_log'); ?>">
                    <p>收益：￥<?php echo (isset($income) && ($income !== '')?$income:'0'); ?></p>
                </a>
            </li>
        </ul>
    </div>
...
<div class="floor my p">
    <div class="content">
        <div class="floor list7 ma-to-20">
            <div class="myorder p">
                <div class="content30">
                    <a href="<?php echo U('Mobile/Partner/storeList'); ?>">
                        <div class="order">
                            <div class="fl">
            ...
            <div class="myorder p">
                <div class="content30">
                    <a href="<?php echo U('Mobile/Partner/store_apply'); ?>">
                        <div class="order">
                            <div class="fl">
            ...
            <div class="myorder p">
                <div class="content30">
                    <a href="<?php echo U('Mobile/Partner/apply'); ?>">
                        <div class="order">
                            <div class="fl">
            ...
            <div class="myorder p">
                <div class="content30">
                    <a href="<?php echo U('Mobile/Partner/orderList'); ?>">
                        <div class="order">
                            <div class="fl">
            ...
            <div class="myorder p">
                <div class="content30">
                    <a href="<?php echo U('Mobile/Partner/deliveryList'); ?>">
                        <div class="order">
                            <div class="fl">
                                <img src="__STATIC__/images/p6.png"/>
                                <span>收货单</span><span style="color: red; font-size:0.5rem;">(公司发给合伙人)</span>
                            </div>
                            <div class="fr">
                                <i class="Mright"></i>
                            </div>
            ...
            <div class="myorder p">
                <div class="content30">
                    <a href="<?php echo U('Mobile/Partner/invoiceList'); ?>">
                        <div class="order">
                            <div class="fl">
                                <img src="__STATIC__/images/p7.png"/>
                                <span>配货单</span><span style="color: red; font-size: 0.5rem">(合伙人配货给工厂店)</span>
                            </div>
                            <div class="fr">
                                <i class="Mright"></i>
                            </div>
