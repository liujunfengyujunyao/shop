<?php
//000000000000s:71166:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
    ...
    <div class="search-box p">
        <div class="w1224">
            <div class="search-path fl">
                                    <a href="/index.php/Home/Goods/goodsList/id/20.html">化妆品</a>
                    <i class="litt-xyb"></i>
                                    <a href="/index.php/Home/Goods/goodsList/id/21.html">口红</a>
                    <i class="litt-xyb"></i>
                                <div class="havedox">
                    <span>迪奥烈艳蓝金唇膏 999</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="product-gallery">
                    <div class="product-photo" id="photoBody">
                        ...
                        <div class="product-img jqzoom">
                            <img id="zoomimg" src="/public/upload/goods/thumb/37/goods_thumb_37_400_400.png" jqimg="/public/upload/goods/thumb/37/goods_thumb_37_800_800.png">
                        </div>
                        <!-- 商品大图介绍 end ]]-->
                        <!-- 商品小图介绍 start [[-->
                        <div class="product-small-img fn-clear"> <a href="javascript:;" class="next-left next-btn fl disabled"></a>
                            <div class="pic-hide-box fl">
                                <ul class="small-pic" style="left:0;">
                                        ...
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/37/goods_sub_thumb_65_60_60.png" data-img="/public/upload/goods/thumb/37/goods_sub_thumb_65_400_400.png" data-big="/public/upload/goods/thumb/37/goods_sub_thumb_65_800_800.png">
                                            <i></i>
                                        </a>
                                        </li>
                                                                            <li class="small-pic-li ">
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/37/goods_sub_thumb_66_60_60.png" data-img="/public/upload/goods/thumb/37/goods_sub_thumb_66_400_400.png" data-big="/public/upload/goods/thumb/37/goods_sub_thumb_66_800_800.png">
                                            <i></i>
                                        </a>
                                        </li>
                                                                    </ul>
                    ...
                    <div class="share">
                        ...
                        <script>
                            var jiathis_config = {
                                url:"http://www.shop.com/index.php?m=Home&c=Goods&a=goodsInfo&id=37",
                                pic:"http://www.shop.com/public/upload/goods/thumb/37/goods_thumb_37_400_400.png",
                            }
            ...
            <form id="buy_goods_form" name="buy_goods_form" method="post" >
                ...
                <div class="shop-price-cou">
                    <div class="shop-price-le">
                        <ul>
                            ...
                            <li>
                                <span class="bigpri_jj" id="goods_price"><em>￥</em>300.00                                <!--<a href=""><em class="sale">（降价通知）</em></a>-->
                                </span>
                            </li>
                        </ul>
                        <ul>
                            <li class="jaj"><span>市场价：</span></li>
                            <li class="though-line"><span><em>￥</em>300.00</span></li>
                        </ul>
                                                <!-- 赠品展示 -->
                                                    <ul>
                    ...
                    <ul>
                        ...
                        <li class="lawir">
                            <div class="minus-plus">
                                ...
                                <input class="buyNum" id="number" type="text" name="goods_num" value="1" onblur="altergoodsnum(0)" max="20"/>
                                <a class="add" href="javascript:void(0);" onclick="altergoodsnum(1)">+</a>
                            </div>
                            <div class="sav_shop">剩余库存：<span id="store_count">19</span></div>
                        </li>
                    </ul>
                    <script>
                        $('#number').val(1);
                ...
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="37" />
                                            <a id="join_cart_now" class="paybybill" href="javascript:;" onclick="AjaxAddCart(37,1,1);">立即购买</a>
                        <a id="join_cart" class="addcar" href="javascript:;" onclick="AjaxAddCart(37,1,0);"><i class="sk"></i>加入购物车</a>
                        ...
                        <a id="no_join_cart" class="addcar" style="display:none;background: #ebebeb;color: #999;cursor: not-allowed"><i class="sk"></i>加入购物车</a>
                                        <!--<a class="paybybill" href="javascript:;" onclick="AjaxAddCart(37,1,1);">立即购买</a>-->
                    <!--<a class="addcar" href="javascript:;" onclick="AjaxAddCart(37,1,0);"><i class="sk"></i>加入购物车</a>-->
                </div>
            </div>
            </form>
            <!--看了又看-s-->
                ...
                <div class="introduceshop">
                    ...
                    <div class="shop-describe shop-con-describe p">
                        <div class="deta-descri">
                            <p class="shopname_de"><span>商品名称：</span><span>迪奥烈艳蓝金唇膏 999</span></p>
                            <div class="ma-d-uli p">
                                <ul>
                                    <!--<li><span>品牌：</span><span>迪奥 Dior</span></li>-->
                                    <li><span>货号：</span><span>TP0000037</span></li>
                                                                    </ul>
                            </div>
                        ...
                        <div class="detail-img-b">
                            <p><img src="/public/upload/temp/2018/08-29/86ef99239f69318692ca785103ef7d20.png" title="86ef99239f69318692ca785103ef7d20.png" alt="86ef99239f69318692ca785103ef7d20.png"/></p>                        </div>
                    </div>
...
<div style="display: none" id="look_see">
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/73.html"><img class="wiahides" src="/public/upload/goods/thumb/73/goods_thumb_73_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/73.html">可乐</a>
            </p>
            <p class="price-tag">
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/74.html"><img class="wiahides" src="/public/upload/goods/thumb/74/goods_thumb_74_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/74.html">雪碧</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>10.00</span>
            </p>
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/75.html"><img class="wiahides" src="/public/upload/goods/thumb/75/goods_thumb_75_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/75.html">芬达</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>10.00</span>
            </p>
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/76.html"><img class="wiahides" src="/public/upload/goods/thumb/76/goods_thumb_76_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/76.html">咖啡</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>15.00</span>
            </p>
        </div>
    </div>
<!--看了又看-s-->
...
//        })
        ...
        function ajaxComment(commentType,page){
            $.ajax({
                type : "GET",
                url:"/index.php?m=Home&c=goods&a=ajaxComment&goods_id=37&commentType="+commentType+"&p="+page,//+tab,
                success: function(data){
