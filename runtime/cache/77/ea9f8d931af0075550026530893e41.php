<?php
//000000000000s:75707:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
                        ...
                        <div class="cata-nav">
                            &lt;!&ndash; 外层循环点&ndash;&gt;
                                    ...
                                    <div class="cata-nav-name">
                                        <h3>
                                            <div class="contiw-cer"><span class="share-icon-20"></span></div>
                                            <a href="/index.php/Home/Goods/goodsList/id/20.html" title="化妆品">化妆品</a>
                                        </h3>
                                    </div>
                                    <b>&gt;</b>
                                </div>
                                    ...
                                    <div class="cata-nav-left">
                                        <div class="subitems">
                                                    ...
                                                    <dt>
                                                        <a href="/index.php/Home/Goods/goodsList/id/21.html" target="_blank">口红<i>&gt;</i></a>
                                                    </dt>
                                                    <dd>
                                                                                                            </dd>
                                                </dl>
    ...
    <div class="search-box p">
        <div class="w1224">
            <div class="search-path fl">
                                    <a href="/index.php/Home/Goods/goodsList/id/22.html">食品饮料</a>
                    <i class="litt-xyb"></i>
                                <div class="havedox">
                    <span>芬达</span>
                </div>
                ...
                <div class="product-gallery">
                    <div class="product-photo" id="photoBody">
                        ...
                        <div class="product-img jqzoom">
                            <img id="zoomimg" src="/public/upload/goods/thumb/75/goods_thumb_75_400_400.jpeg" jqimg="/public/upload/goods/thumb/75/goods_thumb_75_800_800.jpeg">
                        </div>
                        <!-- 商品大图介绍 end ]]-->
                        <!-- 商品小图介绍 start [[-->
                        <div class="product-small-img fn-clear"> <a href="javascript:;" class="next-left next-btn fl disabled"></a>
                            <div class="pic-hide-box fl">
                                <ul class="small-pic" style="left:0;">
                                        ...
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/75/goods_sub_thumb_109_60_60.jpeg" data-img="/public/upload/goods/thumb/75/goods_sub_thumb_109_400_400.jpeg" data-big="/public/upload/goods/thumb/75/goods_sub_thumb_109_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                    </ul>
                    ...
                    <div class="share">
                        ...
                        <script>
                            var jiathis_config = {
                                url:"http://www.shop.com/index.php?m=Home&c=Goods&a=goodsInfo&id=75",
                                pic:"http://www.shop.com/public/upload/goods/thumb/75/goods_thumb_75_400_400.jpeg",
                            }
            ...
            <form id="buy_goods_form" name="buy_goods_form" method="post" >
                ...
                <div class="shop-price-cou">
                    <div class="shop-price-le">
                        <ul>
                            ...
                            <li>
                                <span class="bigpri_jj" id="goods_price"><em>￥</em>10.00                                <!--<a href=""><em class="sale">（降价通知）</em></a>-->
                                </span>
                            </li>
                        </ul>
                        <ul>
                            <li class="jaj"><span>市场价：</span></li>
                            <li class="though-line"><span><em>￥</em>10.00</span></li>
                        </ul>
                                                <!-- 赠品展示 -->
                                                    <ul>
                                <li class="jaj"><span style="color: red;">赠 &nbsp;品：</span></li>
                                <li><span><a href="/index.php/Home/goods/goodsInfo.html"></a></span></li>
                            </ul>
                                            </div>
                ...
                <div class="standard p">
                    <ul>
                        ...
                        <li class="lawir"><span class="service">由<a >后台中心</a>发货并提供售后服务</span></li>
                    </ul>
                </div>
                    ...
                    <ul>
                        ...
                        <li class="lawir">
                            <div class="minus-plus">
                                ...
                                <input class="buyNum" id="number" type="text" name="goods_num" value="1" onblur="altergoodsnum(0)" max="360"/>
                                <a class="add" href="javascript:void(0);" onclick="altergoodsnum(1)">+</a>
                            </div>
                            <div class="sav_shop">剩余库存：<span id="store_count">359</span></div>
                        </li>
                    </ul>
                    <script>
                        $('#number').val(1);
                ...
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="75" />
                                            <a id="join_cart_now" class="paybybill" href="javascript:;" onclick="AjaxAddCart(75,1,1);">立即购买</a>
                        <a id="join_cart" class="addcar" href="javascript:;" onclick="AjaxAddCart(75,1,0);"><i class="sk"></i>加入购物车</a>
                        ...
                        <a id="no_join_cart" class="addcar" style="display:none;background: #ebebeb;color: #999;cursor: not-allowed"><i class="sk"></i>加入购物车</a>
                                        <!--<a class="paybybill" href="javascript:;" onclick="AjaxAddCart(75,1,1);">立即购买</a>-->
                    <!--<a class="addcar" href="javascript:;" onclick="AjaxAddCart(75,1,0);"><i class="sk"></i>加入购物车</a>-->
                </div>
            </div>
            </form>
            <!--看了又看-s-->
                ...
                <div class="introduceshop">
                    ...
                    <div class="shop-describe shop-con-describe p">
                        <div class="deta-descri">
                            <p class="shopname_de"><span>商品名称：</span><span>芬达</span></p>
                            <div class="ma-d-uli p">
                                <ul>
                                    <!--<li><span>品牌：</span><span></span></li>-->
                                    <li><span>货号：</span><span>TP0000075</span></li>
                                                                    </ul>
                            </div>
...
<div class="w1224">
    ...
    <div class="mod_copyright p">
        ...
        <p>Copyright © 2016-2025 后台中心 版权所有 保留一切权利 备案号:粤ICP17092251号</p>
        ...
        <div class="footer-ewmcode">
            <div class="foot-list-fl">
                    ...
                    <li>
                        ...
                        <a class="software_con" href="tencent://message/?uin=123456789&amp;Site=后台中心&amp;Menu=yes" target="_blank">
  ...
  s.parentNode.insertBefore(hm, s);
    ...
    <div class="sidertabs tab-lis-2">
        <div class="icon-tabe-chan advice">
            <a title="点击这里给我发消息" href="tencent://message/?uin=123456789&amp;Site=后台中心&amp;Menu=yes" target="_blank">
                <i class="share-side share-side1"></i>
                <!--<i class="share-side tab-icon-tip"></i>-->
...
<div style="display: none" id="look_see">
        ...
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/50.html"><img class="wiahides" src="/public/upload/goods/thumb/50/goods_thumb_50_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/50.html">ysl黑管唇釉 407</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>320.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/51.html"><img class="wiahides" src="/public/upload/goods/thumb/51/goods_thumb_51_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/51.html">植村秀MOR 570</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>215.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/37.html"><img class="wiahides" src="/public/upload/goods/thumb/37/goods_thumb_37_206_206.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/37.html">迪奥烈艳蓝金唇膏 999</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>300.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/38.html"><img class="wiahides" src="/public/upload/goods/thumb/38/goods_thumb_38_206_206.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/38.html"> 迪奥烈艳蓝金唇膏 080</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>300.00</span>
            </p>
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/39.html"><img class="wiahides" src="/public/upload/goods/thumb/39/goods_thumb_39_206_206.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/39.html">迪奥烈焰蓝金唇膏 775</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>300.00</span>
            </p>
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            ...
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/40.html">迪奥变色润唇膏 </a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>270.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/41.html"><img class="wiahides" src="/public/upload/goods/thumb/41/goods_thumb_41_206_206.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/41.html">mac子弹头唇膏 ruby woo</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>170.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            ...
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/42.html">TF汤姆福特唇膏黑管 16</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>435.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/43.html"><img class="wiahides" src="/public/upload/goods/thumb/43/goods_thumb_43_206_206.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/43.html">CPB双生玫瑰唇膏 311</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>450.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            ...
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/44.html">香奈儿丝绒唇釉 154</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>320.00</span>
            </p>
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/45.html"><img class="wiahides" src="/public/upload/goods/thumb/45/goods_thumb_45_206_206.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/45.html">纪梵希小羊皮 304</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>355.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            ...
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/46.html">阿玛尼红管唇釉 405</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>310.00</span>
            </p>
        </div>
    </div>
<!--看了又看-s-->
...
//        })
        ...
        function ajaxComment(commentType,page){
            $.ajax({
                type : "GET",
                url:"/index.php?m=Home&c=goods&a=ajaxComment&goods_id=75&commentType="+commentType+"&p="+page,//+tab,
                success: function(data){
