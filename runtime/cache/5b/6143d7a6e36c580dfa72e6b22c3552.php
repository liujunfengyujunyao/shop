<?php
//000000000000s:68751:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
                ...
                <div class="product-gallery">
                    <div class="product-photo" id="photoBody">
                        ...
                        <div class="product-img jqzoom">
                            <img id="zoomimg" src="/public/upload/goods/thumb/66/goods_thumb_66_400_400.png" jqimg="/public/upload/goods/thumb/66/goods_thumb_66_800_800.png">
                        </div>
                        <!-- 商品大图介绍 end ]]-->
                        <!-- 商品小图介绍 start [[-->
                        <div class="product-small-img fn-clear"> <a href="javascript:;" class="next-left next-btn fl disabled"></a>
                            <div class="pic-hide-box fl">
                                <ul class="small-pic" style="left:0;">
                                        ...
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/66/goods_sub_thumb_102_60_60.png" data-img="/public/upload/goods/thumb/66/goods_sub_thumb_102_400_400.png" data-big="/public/upload/goods/thumb/66/goods_sub_thumb_102_800_800.png">
                                            <i></i>
                                        </a>
                                        </li>
                                                                    </ul>
                    ...
                    <div class="share">
                        ...
                        <script>
                            var jiathis_config = {
                                url:"http://www.shop.com/index.php?m=Home&c=Goods&a=goodsInfo&id=66",
                                pic:"http://www.shop.com/public/upload/goods/thumb/66/goods_thumb_66_400_400.png",
                            }
            ...
            <form id="buy_goods_form" name="buy_goods_form" method="post" >
                ...
                <div class="shop-price-cou">
                    <div class="shop-price-le">
                        <ul>
                            ...
                            <li>
                                <span class="bigpri_jj" id="goods_price"><em>￥</em>335.00                                <!--<a href=""><em class="sale">（降价通知）</em></a>-->
                                </span>
                            </li>
                        </ul>
                        <ul>
                            <li class="jaj"><span>市场价：</span></li>
                            <li class="though-line"><span><em>￥</em>335.00</span></li>
                        </ul>
                                                <!-- 赠品展示 -->
                                                    <ul>
                ...
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="66" />
                                            <a id="join_cart_now" class="paybybill" href="javascript:;" onclick="AjaxAddCart(66,1,1);">立即购买</a>
                        <a id="join_cart" class="addcar" href="javascript:;" onclick="AjaxAddCart(66,1,0);"><i class="sk"></i>加入购物车</a>
                        ...
                        <a id="no_join_cart" class="addcar" style="display:none;background: #ebebeb;color: #999;cursor: not-allowed"><i class="sk"></i>加入购物车</a>
                                        <!--<a class="paybybill" href="javascript:;" onclick="AjaxAddCart(66,1,1);">立即购买</a>-->
                    <!--<a class="addcar" href="javascript:;" onclick="AjaxAddCart(66,1,0);"><i class="sk"></i>加入购物车</a>-->
                </div>
            </div>
            </form>
            <!--看了又看-s-->
                ...
                <div class="introduceshop">
                    ...
                    <div class="shop-describe shop-con-describe p">
                        <div class="deta-descri">
                            <p class="shopname_de"><span>商品名称：</span><span>ysl哑光唇釉 16</span></p>
                            <div class="ma-d-uli p">
                                <ul>
                                    <!--<li><span>品牌：</span><span>圣罗兰 YSL</span></li>-->
                                    <li><span>货号：</span><span>TP0000066</span></li>
                                                                    </ul>
                            </div>
...
//        })
        ...
        function ajaxComment(commentType,page){
            $.ajax({
                type : "GET",
                url:"/index.php?m=Home&c=goods&a=ajaxComment&goods_id=66&commentType="+commentType+"&p="+page,//+tab,
                success: function(data){
