<?php
//000000000000s:93066:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
            ...
            <div class="detail-img">
                <div class="product-gallery">
                    ...
                    <div class="share">
                        ...
                        <script>
                            var jiathis_config = {
                                url:"http://www.shop.com/index.php?m=Home&c=Goods&a=goodsInfo&id=1",
                                pic:"http://www.shop.com/public/upload/goods/thumb/1/goods_thumb_1_400_400.png",
                            }
                    ...
                    <ul>
                        ...
                        <li class="lawir">
                            <div class="minus-plus">
                                ...
                                <input class="buyNum" id="number" type="text" name="goods_num" value="1" onblur="altergoodsnum(0)" max="2"/>
                                <a class="add" href="javascript:void(0);" onclick="altergoodsnum(1)">+</a>
                            </div>
                            <div class="sav_shop">剩余库存：<span id="store_count">1</span></div>
                        </li>
                    </ul>
                    <script>
                        $('#number').val(1);
