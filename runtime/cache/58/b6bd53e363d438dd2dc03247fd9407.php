<?php
//000000000000s:94102:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
        ...
        <div class="w1224">
            <div class="detail-img">
                <div class="product-gallery">
                    ...
                    <div class="share">
                        ...
                        <script>
                            var jiathis_config = {
                                url:"http://www.shop.com/index.php?m=Home&c=Goods&a=goodsInfo&id=2",
                                pic:"http://www.shop.com/public/upload/goods/thumb/2/goods_thumb_2_400_400.png",
                            }
            ...
            <form id="buy_goods_form" name="buy_goods_form" method="post" >
                ...
                <div class="shop-price-cou">
                    <div class="shop-price-le">
                        <ul>
                            ...
                            <li>
                                <span class="bigpri_jj" id="goods_price"><em>￥</em>198.00                                <!--<a href=""><em class="sale">（降价通知）</em></a>-->
                                </span>
                            </li>
                        </ul>
                        <ul>
                    ...
                    <div class="shop-cou-ri">
                        ...
                        <div class="br1"></div>
                        <div class="allcomm"><p>累计销量</p><p class="f_blue">6</p></div>
                    </div>
                ...
                <!-- 规格 start [[-->
                                        <div class="standard p">
                            <ul>
                                <li class="jaj"><span>净含量：</span></li>
                                <li class="lawir colo">
                                                                            <input type="radio" style="display: none" rel="15" name="goods_spec[净含量]" value="4"  checked="checked"/>
                                        <a   onclick="select_filter(this);"  class="red">15</a>
                                                                            <input type="radio" style="display: none" rel="50" name="goods_spec[净含量]" value="5"  />
                                        <a   onclick="select_filter(this);" >50</a>
                                                                    </li>
                            </ul>
                        </div>
                                    <script>
                    ...
                    <ul>
                        ...
                        <li class="lawir">
                            <div class="minus-plus">
                                ...
                                <input class="buyNum" id="number" type="text" name="goods_num" value="1" onblur="altergoodsnum(0)" max="2433"/>
                                <a class="add" href="javascript:void(0);" onclick="altergoodsnum(1)">+</a>
                            </div>
                            <div class="sav_shop">剩余库存：<span id="store_count">2432</span></div>
                        </li>
                    </ul>
                    <script>
                        $('#number').val(1);
                ...
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="2" />
                        ...
                        <a id="no_join_cart" class="addcar" style="display:none;background: #ebebeb;color: #999;cursor: not-allowed"><i class="sk"></i>加入购物车</a>
                                        <!--<a class="paybybill" href="javascript:;" onclick="AjaxAddCart(2,1,1);">立即购买</a>-->
                    <!--<a class="addcar" href="javascript:;" onclick="AjaxAddCart(2,1,0);"><i class="sk"></i>加入购物车</a>-->
                </div>
            </div>
            </form>
            <!--看了又看-s-->
            ...
            <div class="deta-le-ma">
                ...
                <div class="type_more ma-to-20">
                    ...
                    <div class="tjhot-shoplist type-bot">
                                ...
                                <a href="/index.php/Home/Goods/goodsInfo/id/34.html"><img src="/public/images/icon_goods_thumb_empty_300.png" style="display: inline;"></a>
                                <p class="line-two-hidd"><a href="/index.php/Home/Goods/goodsInfo/id/34.html">秒杀测试</a></p>
...
<div style="display: none" id="look_see">
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/17.html"><img class="wiahides" src="/public/images/icon_goods_thumb_empty_300.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/17.html">饱润肽水漾修护面膜</a>
            </p>
            <p class="price-tag">
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/35.html"><img class="wiahides" src="/public/images/icon_goods_thumb_empty_300.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/35.html">补颜肽</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>388.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/36.html"><img class="wiahides" src="/public/images/icon_goods_thumb_empty_300.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/36.html">饱润肽水漾修护面膜（五四活动）</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>168.00</span>
            </p>
...
//        })
        ...
        {
            var goods_price = 198.00; // 商品起始价
            var store_count = 2433; // 商品起始库存
            var spec_goods_price = {"5":{"key":"5","price":"178.00","store_count":2345},"4":{"key":"4","price":"78.00","store_count":254}};  // 规格 对应 价格 库存表   //alert(spec_goods_price['28_100']['price']);
            // 优先显示抢购活动库存
                        // 如果有属性选择项
