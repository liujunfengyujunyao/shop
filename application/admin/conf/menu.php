...
return	array(	
	...
	'shop'=>array('name'=>'商品','child'=>array(
 ...
 //                array('name'=>'库存日志', 'act'=>'stocklog', 'op'=>'Store')
	...
	*/
	'machine'=>array('name'=>'设备','child'=>array(
			...
			array('name' => '库存管理','child' => array(
				...
				array('name'=>'库存管理', 'act'=>'stockList', 'op'=>'Machine'),
                array('name'=>'库存日志', 'act'=>'stocklog', 'op'=>'Machine')
			)),
			array('name'=>'订单管理','child' => array(
				array('name'=>'订单列表', 'act'=>'orderList', 'op'=>'Machine')
				)),
	)),
	...
	*/
	...
	'partner'=>array('name'=>'仓库','child'=>array(
			array('name' => '基础管理','child' => array(
				array('name'=>'员工列表', 'act'=>'index', 'op'=>'Partner'),
				array('name'=>'提现管理', 'act'=>'withdrawals', 'op'=>'Partner'),
